            ...
            <div className="bg-white rounded-xl border border-gray-200 p-5 space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input name="reraNumber" placeholder="e.g. TN/29/Building/0123/2024"
                    className="w-full text-sm border border-gray-200 rounded-lg px-3 py-2 focus:outline-none focus:ring-1 focus:ring-blue-500" />
                </div>
                <div>
                  <label className="block text-xs font-semibold text-gray-600 mb-1">Preferred Project Size</label>
                  <input name="preferredProjectSize" placeholder="e.g. 10,000–50,000 sqft"
                    className="w-full text-sm border border-gray-200 rounded-lg px-3 py-2 focus:outline-none focus:ring-1 focus:ring-blue-500" />
                </div>
                <div className="sm:col-span-2">
                  <label className="block text-xs font-semibold text-gray-600 mb-1">Preferred Locations</label>
                  <input name="preferredLocations" placeholder="e.g. Adyar, Anna Nagar, T Nagar (comma-separated)"
                    className="w-full text-sm border border-gray-200 rounded-lg px-3 py-2 focus:outline-none focus:ring-1 focus:ring-blue-500" />
                </div>
                <div>
                ...
                <div>
                  ...
                  <input name="financialCapability" placeholder="e.g. Strong, self-funded"
                    className="w-full text-sm border border-gray-200 rounded-lg px-3 py-2 focus:outline-none focus:ring-1 focus:ring-blue-500" />
                </div>
                <div>
