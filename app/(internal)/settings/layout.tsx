      ...
      <div className="flex gap-1 mb-6 border-b border-gray-200 overflow-x-auto no-scrollbar">
        {tabs.map((t) => (
          <Link
            key={t.href}
            href={t.href}
            className="px-3 sm:px-4 py-2 text-sm font-medium text-gray-500 hover:text-gray-900 border-b-2 border-transparent hover:border-gray-300 -mb-px transition-colors whitespace-nowrap flex-shrink-0"
          >
            {t.label}
          </Link>
        ))}
